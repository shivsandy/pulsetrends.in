...
export function generateStaticPages(distDir) {
  ...
  const staticPageDefs = [
    ...
    { path: '/learn', title: `Learn Crypto & IPO - Educational Guides | ${SITE_NAME}`, desc: `Comprehensive educational guides on cryptocurrency, blockchain, IPOs, and investing. Learn the basics and advanced concepts.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }] },
    { path: '/learn/what-is-cryptocurrency', title: `What Is Cryptocurrency? A Beginner's Guide | ${SITE_NAME}`, desc: `Learn what cryptocurrency is, how it works, the different types available, and what you need to know before investing in crypto.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'What Is Cryptocurrency', path: '/learn/what-is-cryptocurrency' }] },
    { path: '/learn/what-is-bitcoin', title: `What Is Bitcoin? The Complete Beginner's Guide | ${SITE_NAME}`, desc: `Learn what Bitcoin is, how it works, who created it, and why it matters. The ultimate beginner's guide to the world's first cryptocurrency.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'What Is Bitcoin', path: '/learn/what-is-bitcoin' }] },
    { path: '/learn/what-is-ethereum', title: `What Is Ethereum? A Beginner's Guide to ETH | ${SITE_NAME}`, desc: `Learn what Ethereum is, how smart contracts work, the difference between ETH and Bitcoin, and why it powers the decentralized web.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'What Is Ethereum', path: '/learn/what-is-ethereum' }] },
    { path: '/learn/what-is-ipo', title: `What Is an IPO? Initial Public Offering Guide | ${SITE_NAME}`, desc: `Learn what an IPO is, how the IPO process works, how to evaluate IPOs, and the risks and rewards of investing in initial public offerings.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'What Is an IPO', path: '/learn/what-is-ipo' }] },
    { path: '/learn/how-to-buy-cryptocurrency-in-india', title: `How to Buy Cryptocurrency in India - 2025 Guide | ${SITE_NAME}`, desc: `Step-by-step guide on how to buy cryptocurrency in India legally. Learn about exchanges, taxes, payment methods, and safe storage.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'How to Buy Crypto in India', path: '/learn/how-to-buy-cryptocurrency-in-india' }] },
    { path: '/learn/how-to-apply-for-ipo', title: `How to Apply for an IPO in India - Step-by-Step Guide | ${SITE_NAME}`, desc: `Complete guide on how to apply for an IPO in India using UPI, ASBA, and your broker. Learn the process, timeline, and tips for IPO allotment.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Learn', path: '/learn' }, { name: 'How to Apply for IPO', path: '/learn/how-to-apply-for-ipo' }] },
    { path: '/author/shiva-sandeep', title: `Shiva Sandeep - Author | ${SITE_NAME}`, desc: `Shiva Sandeep, lead analyst at ${SITE_NAME}. Read articles, guides, and market analysis by Shiva Sandeep covering IPOs, cryptocurrency, and global markets.`, breadcrumbs: [{ name: 'Home', path: '/' }, { name: 'Shiva Sandeep', path: '/author/shiva-sandeep' }] },
  ];
